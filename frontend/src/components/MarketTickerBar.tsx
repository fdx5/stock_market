...
const ICONS: Record<string, string> = {
  "^GSPC": "/img/ticker/spx500.webp",
  "^NDX": "/img/ticker/nas100.webp",
  NVDA: "/img/ticker/nvidia.webp",
  SKHY: "/img/ticker/skhynix.webp",
  MU: "/img/ticker/micron.webp",
  AVGO: "/img/ticker/broadcom.webp",
  INTC: "/img/ticker/intel.webp",
  AMD: "/img/ticker/amd.webp",
  AAPL: "/img/ticker/apple.webp",
  GOOGL: "/img/ticker/google.webp",
  MSFT: "/img/ticker/microsoft.webp",
  META: "/img/ticker/meta.webp",
  TSLA: "/img/ticker/tesla.webp",
  SPCX: "/img/ticker/spacex.webp",
  "CL=F": "/img/ticker/oil.webp",
  "BTC-USD": "/img/ticker/btc.webp",
  "ETH-USD": "/img/ticker/eth.webp",
  "XRP-USD": "/img/ticker/xrp.webp",
};
