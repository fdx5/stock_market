...
export const DICTIONARY: Record<string, string> = {
  ...
  "상승률과 거래대금을 기준으로 지수별 4종목을 선별합니다.": "Four per board, selected on move and turnover.",
  "프리마켓 상승률을 기준으로 지수별 4종목을 선별합니다.":
    "Four per board, selected on the pre-market move.",
  "시장 폭": "Market breadth",
  ...
  "국내": "Korea",
  "미국": "United States",
  "국내 실시간 랭킹": "Korea live ranking",
  "미국 실시간 랭킹": "US live ranking",
  "코스피 500 · 코스닥 200": "KOSPI 500 · KOSDAQ 200",
  "S&P 500 · 나스닥 100": "S&P 500 · Nasdaq 100",
  "전체 랭킹 보기": "See full ranking",
  "장 시작 전이라 당일 거래대금·거래량이 아직 집계되지 않았습니다.":
    "Today's turnover and volume are not counted until the market opens.",
  "아직 집계된 종목이 없습니다.": "Nothing ranked yet.",
  "실시간 인기 종목 토론": "Real-time popular stock discussions",
  "자산 선택": "Choose asset",
  "주식": "Stocks",
  "국내 ETF": "Korea ETFs",
  "해외 ETF": "US ETFs",
  "국내 ETF 랭킹": "Korea ETF ranking",
  "해외 ETF 랭킹": "US ETF ranking",
  "전체 ETF 보기": "See all ETFs",
  "ETF는 거래대금 기준": "ETFs ranked by turnover",
  "종목 선택": "Pick a stock",
  "이 종목을 작업 영역에서 열기": "Open this stock in the workspace",
  "토론방 가기": "Open the board",
  "아직 등록된 토론 글이 없습니다.": "No posts on this board yet.",
  "공감": "Likes",
