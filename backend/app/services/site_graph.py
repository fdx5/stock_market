...
PAGES: list[dict] = [
    ...
    {"id": "page:/desk", "label": "마켓 데스크 1면", "path": "/desk", "group": "stock"},
    ...
    {"id": "page:/global", "label": "해외증시", "path": "/global", "group": "stock"},
    {"id": "page:/global-top100", "label": "글로벌시총", "path": "/global-top100", "group": "stock"},
    {"id": "page:/etf", "label": "ETF", "path": "/etf", "group": "etf"},
    ...
    {"id": "page:/kospi-orbit", "label": "증시궤도 KOSPI", "path": "/kospi-orbit", "group": "map"},
    {"id": "page:/kosdaq-orbit", "label": "증시궤도 KOSDAQ", "path": "/kosdaq-orbit", "group": "map"},
    {"id": "page:/nasdaq100-orbit", "label": "증시궤도 NASDAQ100", "path": "/nasdaq100-orbit", "group": "map"},
    # The classic desk, kept routed (noindex) for readers who still have it bookmarked.
    {"id": "page:/desk2", "label": "클래식 데스크", "path": "/desk2", "group": "stock"},
    {"id": "page:/stocks", "label": "종목정보", "path": "/stocks", "group": "stock"},
    {"id": "page:/map", "label": "코스피 지도", "path": "/map", "group": "map"},
    {"id": "page:/kosdaq-map", "label": "코스닥 지도", "path": "/kosdaq-map", "group": "map"},
    {"id": "page:/sp500-map", "label": "S&P500 지도", "path": "/sp500-map", "group": "map"},
    {"id": "page:/nasdaq100-map", "label": "나스닥 지도", "path": "/nasdaq100-map", "group": "map"},
    {"id": "page:/realestate-map", "label": "부동산 지도", "path": "/realestate-map", "group": "map"},
    {"id": "page:/kospi-100", "label": "TOP100 코스피", "path": "/kospi-100", "group": "board"},
    {"id": "page:/kosdaq-100", "label": "TOP100 코스닥", "path": "/kosdaq-100", "group": "board"},
    {"id": "page:/nasdaq-100", "label": "TOP100 나스닥", "path": "/nasdaq-100", "group": "board"},
    ...
    {"id": "page:/stock/{code}", "label": "종목상세 (국내)", "path": "/stock/{code}", "group": "stock"},
    {"id": "page:/stock/{ticker}", "label": "종목상세 (해외)", "path": "/stock/{ticker}", "group": "stock"},
    ...
    {"id": "page:/ai-prediction", "label": "AI예측", "path": "/ai-prediction", "group": "predict"},
    ...
    # Search landing pages (SearchLandingPage): one component, a page per kind.
    {"id": "page:/sector/semiconductor", "label": "반도체 관련주", "path": "/sector/semiconductor", "group": "board"},
    {"id": "page:/ranking/trading-value", "label": "거래대금 순위", "path": "/ranking/trading-value", "group": "board"},
    {"id": "page:/market/kospi/foreign-buying", "label": "외국인·기관 수급", "path": "/market/kospi/foreign-buying", "group": "market"},
    {"id": "page:/ranking/us-etf", "label": "미국 ETF 순위", "path": "/ranking/us-etf", "group": "etf"},
    {"id": "page:/ranking/sp500-market-cap", "label": "S&P500 시총 순위", "path": "/ranking/sp500-market-cap", "group": "board"},
    {"id": "page:/etf/compare", "label": "ETF 비교", "path": "/etf/compare", "group": "etf"},
    ...
    {"id": "page:/admin/live", "label": "실시간 접속", "path": "/admin/live", "group": "admin"},
]
...
PAGE_CALLS: dict[str, list[str]] = {
    ...
    "page:/etf": [
        ...
        "/api/global/indices",
        "/api/global/{code}/discussion",
        "/api/global/{code}/toss-discussion",
        "/api/investor/indices",
        "/api/market/weather",
        "/api/search",
        "/api/search/popular",
    ...
    "page:/stocks": [
        ...
        "/api/etfs/{code}/toss-discussion",
        "/api/global/indices",
        "/api/global/toss-news-article",
        "/api/global/{code}/toss-discussion",
        "/api/global/{code}/toss-news",
        "/api/investor/indices",
        "/api/market/weather",
        "/api/search",
        "/api/search/popular",
    ...
    # Added with the pages above; the landing pages share the broadsheet chrome's calls.
    "page:/desk2": [
        "/api/etfs",
        "/api/global/indices",
        "/api/global/{code}/discussion",
    ...
    "page:/sector/semiconductor": [
        "/api/market/map",
        "/api/market/kosdaq-map",
    ],
    "page:/ranking/trading-value": [
        "/api/market/map",
        "/api/market/kosdaq-map",
    ],
    "page:/market/kospi/foreign-buying": [
        "/api/investor/summary",
        "/api/market/map",
    ],
    "page:/ranking/us-etf": [
