...
MAPO = (
    ...
    + _dong("대흥동", "대흥동 세양아파트", "마포그랑자이아파트", "마포태영제2", "마포태영아파트")
)
BUNDANG = (
    ...
    + _dong("백현동", "판교백현마을8단지", "판교백현마을7단지", "백현마을9단지대림e-편한세상")
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("대흥동태영아파트", "대흥동", MAPO, "마포태영아파트"),
        ("백현마을8단지(대림)", "백현동", BUNDANG, "판교백현마을8단지"),
        ("백현마을9단지(e편한세상)", "백현동", BUNDANG, "백현마을9단지대림e-편한세상"),
